...
model_weights_file = "./models/Xception_weight_1.h5"
sub_file = './sub/Xception1_submission.txt'
#cnn_model_file = './models/cnn_basic_50_epochs.model'
#cnn_model_file = './models/cnn_basic_10_epochs.model'
cnn_model_file = "./models/Xception1Recent.model"
...
def buildModel( init = False ):
    ...
    top_tensor = Dense(512, activation='sigmoid', name='dense1')(top_tensor)
